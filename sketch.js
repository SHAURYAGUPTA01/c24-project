...
function setup() {
  ...
  computerArcher = new ComputerArcher(computer.body.position.x,computerBase.body.position.y - 180,120,120,60);
  playerArcher = new PlayerArcher(player.body.position.x,playerBase.body.position.y - 180,120,120)
